...
**Invariantes.** [exactamente-un-exito-bajo-carrera](../invariantes/exactamente-un-exito-bajo-carrera.md), [colas-limpias-happy-path](../invariantes/colas-limpias-happy-path.md)
