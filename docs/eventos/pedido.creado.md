...
**Invariantes.** [no-oversell](../invariantes/no-oversell.md), [idempotencia-directa](../invariantes/idempotencia-directa.md), [colas-limpias-happy-path](../invariantes/colas-limpias-happy-path.md)
